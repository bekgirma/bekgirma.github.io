...
**Data Science**: Data Visualization, Machine Learning, Statistical Analysis, Data Analysis, Data Transformation \
**Tools**: Excel, Tableau, Docker \
...
- Document and track all activities related to the account or project using the organization's designated software. 

# Projects 
## Video Game Reviews Classification using NLP with Recurrent Neural Networks (Python) 
Description: Designed and implemented a Recurrent Neural Network in Python to accurately predict whether a review expressed positive, neutral, or negative sentiment. 
- Used Python’s BeautifulSoup library to scrape a diverse dataset of video game reviews from Metacritic. 
...
- Obtained an accuracy score of 91.2% using the fitted model on a test dataset. 
